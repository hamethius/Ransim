...
public class Converter {
    public static void main(String[] args) {
        try {
            ...
            String classDir = currentDir + File.separator + "classes";
            String jarFile = currentDir + File.separator + "main.jar";
            String configFile = currentDir + File.separator + "config.xml";
            String exeOutput = currentDir + File.separator + "main.exe";
            ...
            ProcessBuilder compileBuilder = new ProcessBuilder("javac", "-d", classDir, "*.java");
            ...
            // Step 2: Create JAR
            ProcessBuilder jarBuilder = new ProcessBuilder("jar", "cfe", jarFile, mainClass, "-C", classDir, ".");
            ...
            // Add required <jre> section
            writer.println("  <jre>");
            writer.println("    <path></path>");
            writer.println("    <minVersion>1.8.0</minVersion>");
            ...
            // Add complete <versionInfo> with <internalName>
            ...
            writer.println("    <internalName>main</internalName>"); // ✅ Important
